\section*{Prototype of Electromagnetic Spectrum Monitor}
...
\begin{itemize}
	...
	\begin{figure}[h!]
		\centering
		\resizebox{0.51\textwidth}{!}{\includegraphics{Figures/doa2.png}}	
		\resizebox{0.48\textwidth}{!}{\includegraphics{Figures/doa1.png}}
	...
	\begin{figure}[h!]
		\centering
		\resizebox{ 0.63\textwidth}{!}{\includegraphics{Figures/doa3.png}}
		\resizebox{ 0.21\textwidth}{!}{\includegraphics{Figures/doa4.png}}
		\caption{Diagram of the Electromagnetic Spectrum Monitoring System}
	\end{figure}
