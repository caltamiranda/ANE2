...
const Rni = () => {
    ...
    const selectItem = (id) => {
        ...
        setSelectedItems([...selectedItems, {...item, measure:'RNI', startDate:null, endDate:null}]);
    }
    ...
    const verificationRNI = (items,timeInterval=false) => {
        let result = true;
        // console.log(items);
        if (timeInterval){
            items.map(item => {
        ...
        <Dashboard>
            <div className={styles.mainContainer}>
                ...
                <ActionBlock
                    ...
                    blockButton={selectedItems.length!=0 ? verificationRNI(selectedItems,withTime): false}
